...
from .new_match_history_handler import router as new_match_history_router
...
__all__ = ['main_router', 'stats_router', 'match_router', 'profile_router', 'settings_router', 'new_match_history_router', 'form_analysis_router', 'last_match_router', 'current_match_router', 'comparison_router', 'help_router']